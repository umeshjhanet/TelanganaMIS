...
const CumulativeReport = () => {
  ...
  const fetchDetailed = async (params = {}) => {
    try {
      const response = await axios.get(`${API_URL}/api/daily-summary`, {
        params,
      });
              ...
              <div className="table-card">
                ...
                <div className="row ">
                  <div className="col-md-8 d-md-block d-none col-11">
                    <h5 className="mt-2">
                      Telangana - Process & Manpower Detailed Summary:{" "}
                      <span style={{ color: "#AC1754" }}>
                        {!selectedDate
                  ...
                  <div className="col-md-2 col-5">
                    <button
                      className="btn add-btn p-2 w-100"
                      style={{
                        marginLeft: "0px",
                        fontSize: "12px",
                  ...
                  <div className="col-md-2 col-5">
                    <button
                      className="p-2 btn add-btn w-100"
                      onClick={exportToCSV}
                      style={{
                        marginLeft: "0px",
                        fontSize: "12px",
                    ...
                    <tbody>
                      {Array.isArray(cumulative) &&
                        cumulative.map((elem, index) => {
                          const targetObj = target.find(
                            (t) => t.process_name === elem.process
                          );
                          const targetValue = targetObj
                            ? parseFloat(targetObj.target)
                            : 0;
                  ...
                  <div className="table-card" style={{ marginBottom: "0px" }}>
                    <div className="row ms-1 mt-1">
                      <div className="col-10">
                        <h5 className="mt-2">
                          Telangana - Process & Manpower Location Wise Report:{" "}
                          <span style={{ color: "#AC1754" }}>
                            {!selectedDate
                              ? formattedYesterdayDate
                    ...
                    <div className="row mt-3 ms-2 me-2">
                      <div className="col-lg-4 col-md-2 col-sm-12">
                        ...
                        >
                          ...
                          <span
                            style={{ minWidth: "5px", display: "inline-block" }}
                          >
                            &#8203;
                          </span>
                        </div>
                      ...
                      <div
                        className="col-lg-4 col-md-2 col-sm-12"
                          ...
                          >
                            {processOptions.map((item, index) => (
                              <div
                                ...
                                style={{
                                  padding: "8px",
                                  cursor: selectedProcesses.includes(item)
                                    ? "not-allowed"
                                    : "pointer",
                                  backgroundColor: selectedProcesses.includes(
                                    item
                                  )
                                    ? "#e9ecef"
                                    : "white",
                      ...
                      <table className="table table-hover table-bordered table-responsive date-table">
                        ...
                        >
                          ...
                          >
                            ...
                            <th colSpan={processesToRender.length * 6}>
                              Processes
                            </th>
                          </tr>
                          <tr
