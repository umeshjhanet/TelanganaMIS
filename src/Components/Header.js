                  ...
                  <div className='sidebar'>
                    ...
                    {showReportDropdown && (
                      <>
                        ...
                        <br/><Link to='/dailyReport' className='ms-5' style={{ color: 'black', textDecoration: 'none', marginTop: '20px', cursor: 'pointer' }}><VscGraph style={{ marginRight: '10px', fontSize: '20px', color: '#107393' }} />Daily Report</Link>
                        <hr />
                      </>
                    )}
                    <div className='row mt-1' onClick={handleActiveTab}>
              ...
              <div className='mobile-sidebar'>
                ...
                {showReportDropdown && (
                  <>
                    ...
                    <Link to='/dailyReport' className='ms-5' style={{ color: 'black', textDecoration: 'none', marginTop: '20px', cursor: 'pointer' }}><VscGraph style={{ marginRight: '10px', fontSize: '20px', color: '#107393' }} />Daily Report</Link>
                    <hr />
                  </>
                )}
                <div className='row' onClick={handleActiveTab}>
