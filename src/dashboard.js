...
const Dashboard = () => {
  ...
  useEffect(() => {
      ...
      if (selectedLocations.length > 0) {
        try {
          ...
          const locationDataResponses = await Promise.all(selectedLocations.map(location =>
            axios.get(`http://192.168.3.119:8080/api/locationwisetabularData?locationName=?`)
          ));
    ...
    const fetchGraphFileData = (selectedLocations) => {
      let apiUrl = 'http://192.168.3.119:8080/graph1LocationWise';
    ...
    const fetchExportCsvFile = () => {
      ...
      const apiUrl = locationName ? `http://192.168.3.119:8080/csv?${locationName.map(name => `locationName=${name}`).join('&')}` : 'http://192.168.3.119:8080/csv';
    ...
    const fetchGraphImageData = (selectedLocations) => {
      let apiUrl = 'http://192.168.3.119:8080/graph2';
    ...
    const fetchTodayGraphFileData = () => {
      let apiUrl = 'http://192.168.3.119:8080/graph7';
    ...
    const fetchTodayGraphImageData = () => {
      let apiUrl = 'http://192.168.3.119:8080/graph8';
    ...
    const fetchWeekFileGraphData = () => {
      ...
      axios.get('http://192.168.3.119:8080/graph5', params)
        .then(response => {
          const apiData = response.data;
    ...
    const fetchWeekImageGraphData = () => {
      ...
      axios.get('http://192.168.3.119:8080/graph6', params)
        .then(response => {
          const apiData = response.data;
          const labels = apiData.map(item => item["scandate"]);
    ...
    const fetchMonthImageGraphData=()=>{
      ...
      axios.get('http://192.168.3.119:8080/graphmonth', params)
        .then(response => {
          const apiData = response.data;
        const labels=apiData.map(item =>item['scandate'])
    ...
    const fetchCivilCaseGraphData = () => {
      let apiUrl = 'http://192.168.3.119:8080/civil';
    ...
    const fetchCriminalCaseGraphData = () => {
      let apiUrl = 'http://192.168.3.119:8080/criminal';
    ...
    const fetchAllYesGraphImageData = (selectedLocations) => {
      let apiUrl = 'http://192.168.3.119:8080/graph9';
    ...
    const fetchAllGraphImageData = (selectedLocations) => {
      let apiUrl = 'http://192.168.3.119:8080/graph10';
    ...
    const fetchTableData = () => {
      axios.get("http://192.168.3.119:8080/tabularData")
        .then(response => {
