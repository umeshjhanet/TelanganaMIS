              ...
              <div className='row'>
                ...
                <div className='col-6'>
                  <div className='user-form-card'>
                    ...
                    <input type='date' placeholder='13-03-24' name="last_pass_change" style={{ width: '100%', height: '35px', border: '1px solid lightgray', borderRadius: '2px' }} onChange={handleInputChange}/><br />
