...
const [formData,setFormData]=useState({
  ...
  const handleInputChange = (e) => {
    ...
    setFormData({ ...formData, [name]: value, group_id: selectedGroupId, LocationId:selectedLocationId,role_id: selectedPrivilegeId, sl_id: selectedStorageId, user_id: selectedReportingId});
  }
              ...
              <div className='row'>
                <div className='col-6'>
                  <div className='user-form-card'>
                    ...
                    <input type='text' placeholder='Enter Last Name' style={{ width: '100%', height: '35px', border: '1px solid lightgray', borderRadius: '2px' }} onChange={handleInputChange} /><br />
                    ...
                    <input type='password' placeholder='Confirm Password' style={{ width: '100%', height: '35px', border: '1px solid lightgray', borderRadius: '2px' }} onChange={handleInputChange} /><br />
                    <label className='mt-1'>User Type</label>
                    <select name="usertype" id="usertype" class="form-control select2"  onChange={handleInputChange}>
                ...
                <div className='col-6'>
                  <div className='user-form-card'>
                    ...
                    <input type='text' placeholder='Select Designation' name="designation" style={{ width: '100%', height: '35px', border: '1px solid lightgray', borderRadius: '2px' }} /><br />
